		...
		<g id="finals" onClick={onClick} transform={`translate(${x}, ${y})`}>
			<g id="finalsContainer">
				...
				<g id="trophy" transform="translate(180.36, 70.79)">
					...
					{/* Original: M1194.42,366.13 -> Relative: (1194.42-1204.36, 366.13-414.19) = (-9.94, -48.06) */}
					<path fill="#FFCA10" d="M-9.94,-48.06c0,11.89,10.39,21.54,23.2,21.54c12.81,0,23.2-9.65,23.2-21.54h-46.4z M13.26,-28.99c-10.51,0-19.21-7.23-20.54-16.57h41.08C33.48,-20.76,24.77,-28.99,13.26,-28.99z"/>
