...
function Bracket({ selectedEvent, playoffSchedule, alliances }) {
	...
	return (
		...
		436.71,647.99 629.72,647.99 629.72,508.99 436.71,508.99 436.71,567.12 364.94,567.12 	"/>
					...
					<path id="finalsBackground" fill="#C1C1C1" stroke="#000000" strokeWidth="2" strokeMiterlimit="10" d="M1254.49,486.55H1024
		c-5.5,0-10-4.5-10-10v-111.1c0-5.5,4.5-10,10-10h230.49c5.5,0,10,4.5,10,10v111.1C1264.49,482.05,1259.99,486.55,1254.49,486.55z"
				...
				<g id="finals">
					<g id="finalsContainer">
						...
						<line fill="none" stroke="#FFFFFF" strokeMiterlimit="10" x1="1157.7" y1="422.75" x2="1019" y2="422.75" />
						...
						<text transform="matrix(0.9941 0 0 1 1099.6 401.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(13,"red") ? allianceName(13,"red") : "Winner of M11"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(13, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 1099.6 437.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(13,"blue") ? allianceName(13,"blue") : "Winner of M13"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(13, "blue")}</tspan></text>
					</g>
					<g id="trophy">
			...
			c-10.51,0-19.21-7.23-20.54-16.57h41.08C1236.84,377.96,1228.13,385.19,1217.62,385.19z"/>
					...
					<text id="finalsM1Scores"
						transform="matrix(1 0 0 1 1187.8 455.5537)">
						...
						<tspan x="0" y="14" fill={BLUE} fontFamily="'myriad-pro'"
							...
							fontStyle={"normal"}
							fontSize="14px" textAnchor="middle">{matches[13]?.scoreBlueFinal}</tspan></text>
					<text id="finalsM2Scores" transform="matrix(1 0 0 1 1216.8 455.5537)">
						<tspan x="0" y="0"
							fill={RED}
					...
					<text id="finalsM3Scores"
						transform="matrix(1 0 0 1 1245.8 455.5537)">
						<tspan x="0" y="0"
							fill={RED}
							fontFamily="'myriad-pro'"
				...
				<g id="match13">
					<g>
						<polygon fill={RED} points="984.7,504.56 848.43,504.56 848.43,468.54 984.7,468.54 997.64,486.55 		" stroke={(matches[12]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="984.7,541 848.43,541 848.43,504.99 984.7,504.99 997.64,522.99 		" stroke={(matches[12]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 906.5 483.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(12,"red") ? allianceName(12,"red") : "Loser of M11"}</tspan><tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(12, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 906.5 519.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(12,"blue") ? allianceName(12,"blue") : "Winner of M12"}</tspan><tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(12, "blue")}</tspan></text>
				...
				<g id="match12">
					<g>
						<polygon fill={RED} points="802.7,574.56 666.43,574.56 666.43,538.54 802.7,538.54 815.64,556.55 		" stroke={(matches[11]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="802.7,611 666.43,611 666.43,574.99 802.7,574.99 815.64,592.99 		" stroke={(matches[11]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 725 553.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(11,"red") ? allianceName(11,"red") : "Winner of M10"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(11, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 725 589.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(11,"blue") ? allianceName(11,"blue") : "Winner of M9"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(11, "blue")}</tspan></text>
				...
				<g id="match11">
					<g>
						<polygon fill={RED} points="802.7,254.56 666.43,254.56 666.43,218.54 802.7,218.54 815.64,236.55 		" stroke={(matches[10]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="802.7,291 666.43,291 666.43,254.99 802.7,254.99 815.64,272.99 		" stroke={(matches[10]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 725 233.1807)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(10, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 725 269.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(10,"blue") ? allianceName(10,"blue") : "Winner of M8"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(10, "blue")}</tspan></text>
				...
				<g id="match10">
					<g>
						<polygon fill={RED} points="611.7,508.56 475.43,508.56 475.43,472.54 611.7,472.54 624.64,490.55 		" stroke={(matches[9]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="611.7,545 475.43,545 475.43,508.99 611.7,508.99 624.64,526.99 		"stroke={(matches[9]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5" />
						...
						<text transform="matrix(0.9941 0 0 1 533 487.1807)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(9, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 533 523.6221)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(9, "blue")}</tspan></text>
				...
				<g id="match9">
					<g>
						<polygon fill={RED} points="611.7,647.56 475.43,647.56 475.43,611.54 611.7,611.54 624.64,629.55 		" stroke={(matches[8]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="611.7,684 475.43,684 475.43,647.99 611.7,647.99 624.64,665.99 		" stroke={(matches[8]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 533 626.1807)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(8, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 533 662.6221)" textAnchor="middle">
							...
							<tspan x="-0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(8, "blue")}</tspan></text>
				...
				<g id="match8">
					<g>
						<polygon fill={RED} points="412.7,328.56 276.43,328.56 276.43,292.54 412.7,292.54 425.64,310.55 		" stroke={(matches[7]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="412.7,365 276.43,365 276.43,328.99 412.7,328.99 425.64,346.99 		" stroke={(matches[7]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 334.6 307.1807)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(7, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 334.6 343.6221)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(7, "blue")}</tspan></text>
				...
				<g id="match7">
					<g>
						<polygon fill={RED} points="412.7,174.56 276.43,174.56 276.43,138.54 412.7,138.54 425.64,156.55 		" stroke={(matches[6]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="412.7,211 276.43,211 276.43,174.99 412.7,174.99 425.64,192.99 		" stroke={(matches[6]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 334.6 153.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(6,"red") ? allianceName(6,"red") : "Winner of M1"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(6, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 334.6 189.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(6,"blue") ? allianceName(6,"blue") : "Winner of M2"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(6, "blue")}</tspan></text>
				...
				<g id="match6">
					<g>
						<polygon fill={RED} points="412.7,721.56 276.43,721.56 276.43,685.54 412.7,685.54 425.64,703.55 		" stroke={(matches[5]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="412.7,758 276.43,758 276.43,721.99 412.7,721.99 425.64,739.99 		" stroke={(matches[5]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 334.6 700.1807)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(5, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 334.6 736.6221)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(5, "blue")}</tspan></text>
				...
				<g id="match5">
					<g>
						<polygon fill={RED} points="412.7,567.56 276.43,567.56 276.43,531.54 412.7,531.54 425.64,549.55 		" stroke={(matches[4]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="412.7,604 276.43,604 276.43,567.99 412.7,567.99 425.64,585.99 		" stroke={(matches[4]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 334.6 546.1807)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(4, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 334.6 582.6221)" textAnchor="middle">
							...
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(4, "blue")}</tspan></text>
				...
				<g id="match4">
					<g>
						<polygon fill={RED} points="223.7,367.56 87.43,367.56 87.43,331.54 223.7,331.54 236.64,349.55 		" stroke={(matches[3]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="223.7,404 87.43,404 87.43,367.99 223.7,367.99 236.64,385.99 		" stroke={(matches[3]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 145.6 346.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(3,"red") ? allianceName(3,"red") : "Alliance 3"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(3, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 145.6 382.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(3,"blue") ? allianceName(3,"blue") : "Alliance 6"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(3, "blue")}</tspan></text>
				...
				<g id="match3">
					<g>
						<polygon fill={RED} points="223.7,290.56 87.43,290.56 87.43,254.54 223.7,254.54 236.64,272.55 		" stroke={(matches[2]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="223.7,327 87.43,327 87.43,290.99 223.7,290.99 236.64,308.99 		" stroke={(matches[2]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 145.6 269.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(2,"red") ? allianceName(2,"red") : "Alliance 2"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(2, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 145.6 305.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(2,"blue") ? allianceName(2,"blue") : "Alliance 7"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(2, "blue")}</tspan></text>
				...
				<g id="match2">
					<g>
						<polygon fill={RED} points="223.7,213.56 87.43,213.56 87.43,177.54 223.7,177.54 236.64,195.55 		" stroke={(matches[1]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="223.7,250 87.43,250 87.43,213.99 223.7,213.99 236.64,231.99 		" stroke={(matches[1]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 145.6 192.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(1,"red") ? allianceName(1,"red") : "Alliance 4"}</tspan><tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(1, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 145.6 228.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(1,"blue") ? allianceName(1,"blue") : "Alliance 5"}</tspan><tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(1, "blue")}</tspan></text>
				...
				<g id="match1">
					<g>
						<polygon fill={RED} points="223.7,136.56 87.43,136.56 87.43,100.54 223.7,100.54 236.64,118.55 		" stroke={(matches[0]?.winner.winner === "red") ? GOLD : "none"} strokeWidth="5"/>
						<polygon fill={BLUE} points="223.7,173 87.43,173 87.43,136.99 223.7,136.99 236.64,154.99 		" stroke={(matches[0]?.winner.winner === "blue") ? GOLD : "none"} strokeWidth="5"/>
						...
						<text transform="matrix(0.9941 0 0 1 145.6 115.1807)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(0,"red") ? allianceName(0,"red") : "Alliance 1"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(0, "red")}</tspan></text>
						<text transform="matrix(0.9941 0 0 1 145.6 150.6221)" textAnchor="middle">
							<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceName(0,"blue") ? allianceName(0,"blue") : "Alliance 8"}</tspan>
							<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{allianceNumbers(0, "blue")}</tspan>
						</text>
