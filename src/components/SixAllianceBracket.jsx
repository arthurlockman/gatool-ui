	...
	return (
		...
		c5.5,0,10,4.5,10,10v158.1C1264.5,507.1,1260,511.6,1254.5,511.6z"/>
			...
			c-10.51,0-19.21-7.23-20.54-16.57h41.08C1236.84,377.96,1228.13,385.19,1217.62,385.19z"/>
							...
							<circle id="winnerMatch1Dot" fill={(getMatchWinnerForDisplay(10)?.winner === "red") ? RED : (getMatchWinnerForDisplay(10)?.winner === "blue") ? BLUE : (getMatchWinnerForDisplay(10)?.winner === "tie") ? GREEN : "none"} cx={`${1132 - overtimeOffset}`} cy="451" r="8" />
							<text id="finalsM1Scores" transform={`matrix(1 0 0 1 ${1132 - overtimeOffset} 477.5537)`}>
								<tspan x="0" y="0" fill={RED} fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(10)?.winner === "red") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(10, "red")}</tspan>
								<tspan x="0" y="14" fill={BLUE} fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(10)?.winner === "blue") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(10, "blue")}</tspan>
							</text>

							<circle id="winnerMatch2Dot" fill={(getMatchWinnerForDisplay(11)?.winner === "red") ? RED : (getMatchWinnerForDisplay(11)?.winner === "blue") ? BLUE : (getMatchWinnerForDisplay(11)?.winner === "tie") ? GREEN : "none"} cx={`${1162 - overtimeOffset}`} cy="451" r="8" />
							<text id="finalsM2Scores" transform={`matrix(1 0 0 1 ${1162 - overtimeOffset} 477.5537)`}>
								<tspan x="0" y="0"
									fill={RED}
									fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(11)?.winner === "red") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(11, "red")}</tspan>
								<tspan x="0" y="14" fill={BLUE}
									fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(11)?.winner === "blue") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(11, "blue")}</tspan>
							</text>

							<circle id="winnerMatch3Dot" fill={(getMatchWinnerForDisplay(12)?.winner === "red") ? RED : (getMatchWinnerForDisplay(12)?.winner === "blue") ? BLUE : (getMatchWinnerForDisplay(12)?.winner === "tie") ? GREEN : "none"} cx={`${1192 - overtimeOffset}`} cy="451" r="8" />
							<text id="finalsM3Scores"
								transform={`matrix(1 0 0 1 ${1192 - overtimeOffset} 477.5537)`}>
								<tspan x="0" y="0"
									fill={RED}
									fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(12)?.winner === "red") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(12, "red")}</tspan>
								<tspan x="0" y="14" fill={BLUE}
									fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(12)?.winner === "blue") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(12, "blue")}</tspan>
							</text>

							<circle id="winnerMatch4Dot" fill={(getMatchWinnerForDisplay(13)?.winner === "red") ? RED : (getMatchWinnerForDisplay(13)?.winner === "blue") ? BLUE : (getMatchWinnerForDisplay(13)?.winner === "tie") ? GREEN : "none"} cx={`${1222 - overtimeOffset}`} cy="451" r="8" />
							<text id="finalsM4Scores"
								transform={`matrix(1 0 0 1 ${1222 - overtimeOffset} 477.5537)`}>
								<tspan x="0" y="0"
									fill={RED}
									fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(13)?.winner === "red") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(13, "red")}</tspan>
								<tspan x="0" y="14" fill={BLUE}
									fontFamily="'myriad-pro'"
									fontWeight={(getMatchWinnerForDisplay(13)?.winner === "blue") ? black : semibold}
									fontStyle={"normal"}
									fontSize="14px" textAnchor="middle">{getMatchScoreForDisplay(13, "blue")}</tspan>
							</text>

							<circle id="winnerMatch5Dot" fill={(getMatchWinnerForDisplay(14)?.winner === "red") ? RED : (getMatchWinnerForDisplay(14)?.winner === "blue") ? BLUE : (getMatchWinnerForDisplay(14)?.winner === "tie") ? GREEN : "none"} cx={`${1252 - overtimeOffset}`} cy="451" r="8" />
							...
							<circle id="winnerMatch6Dot" fill={(getMatchWinnerForDisplay(15)?.winner === "red") ? RED : (getMatchWinnerForDisplay(15)?.winner === "blue") ? BLUE : (getMatchWinnerForDisplay(15)?.winner === "tie") ? GREEN : "none"} cx={`${1282 - overtimeOffset}`} cy="451" r="8" />
							<text id="finalsM5Scores"
