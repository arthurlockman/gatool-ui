		...
		c5.5,0,10,4.5,10,10v158.1C1264.5,507.1,1260,511.6,1254.5,511.6z"/>
							...
							<text transform={ftcMode ? "matrix(0 -1.0059 1 0 1041.7773 409.6328)" : "matrix(0 -1.0059 1 0 1041.7773 418.6328)"} fill={(ftcMode ? (isCurrentMatch(10) || isCurrentMatch(11) || isCurrentMatch(12) || isCurrentMatch(13) || isCurrentMatch(14) || isCurrentMatch(15)) : currentPlayoffMatch >= 14) ? BLACK : WHITE} fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize={"12.076px"}>{ftcMode ? "FINALS" : "BEST 2 of 3"}</text>
								...
								<text transform="matrix(0.9941 0 0 1 1106 404)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(10, "blue") ? getAllianceNameForDisplay(10, "blue") : "Winner of M9"}</tspan>
			...
			c-10.51,0-19.21-7.23-20.54-16.57h41.08C1236.84,377.96,1228.13,385.19,1217.62,385.19z"/>
							...
							{shouldDisplayFinalsMatch(10) && (
								<>
									<circle id="winnerMatch1Dot" fill={(getFinalsMatchWinnerForDisplay(10)?.winner === "red") ? RED : (getFinalsMatchWinnerForDisplay(10)?.winner === "blue") ? BLUE : (getFinalsMatchWinnerForDisplay(10)?.winner === "tie") ? GREEN : "none"} cx={`${1132 - overtimeOffset}`} cy="451" r="8" />
							...
							{shouldDisplayFinalsMatch(11) && (
								<>
									<circle id="winnerMatch2Dot" fill={(getFinalsMatchWinnerForDisplay(11)?.winner === "red") ? RED : (getFinalsMatchWinnerForDisplay(11)?.winner === "blue") ? BLUE : (getFinalsMatchWinnerForDisplay(11)?.winner === "tie") ? GREEN : "none"} cx={`${1162 - overtimeOffset}`} cy="451" r="8" />
							...
							{shouldDisplayFinalsMatch(12) && (
								<>
									<circle id="winnerMatch3Dot" fill={(getFinalsMatchWinnerForDisplay(12)?.winner === "red") ? RED : (getFinalsMatchWinnerForDisplay(12)?.winner === "blue") ? BLUE : (getFinalsMatchWinnerForDisplay(12)?.winner === "tie") ? GREEN : "none"} cx={`${1192 - overtimeOffset}`} cy="451" r="8" />
									<text id="finalsM3Scores"
										transform={`matrix(1 0 0 1 ${1192 - overtimeOffset} 477.5537)`}>
										<tspan x="0" y="0"
											fill={RED}
											fontFamily="'myriad-pro'"
											fontWeight={(getFinalsMatchWinnerForDisplay(12)?.winner === "red") ? black : semibold}
											fontStyle={"normal"}
											fontSize="14px" textAnchor="middle">{getFinalsMatchScoreForDisplay(12, "red")}</tspan>
										<tspan x="0" y="14" fill={BLUE}
											fontFamily="'myriad-pro'"
											fontWeight={(getFinalsMatchWinnerForDisplay(12)?.winner === "blue") ? black : semibold}
											fontStyle={"normal"}
											fontSize="14px" textAnchor="middle">{getFinalsMatchScoreForDisplay(12, "blue")}</tspan>
									</text>
								</>
							)}
							...
							{shouldDisplayFinalsMatch(13) && (
								<>
									<circle id="winnerMatch4Dot" fill={(getFinalsMatchWinnerForDisplay(13)?.winner === "red") ? RED : (getFinalsMatchWinnerForDisplay(13)?.winner === "blue") ? BLUE : (getFinalsMatchWinnerForDisplay(13)?.winner === "tie") ? GREEN : "none"} cx={`${1222 - overtimeOffset}`} cy="451" r="8" />
									<text id="finalsM4Scores"
										transform={`matrix(1 0 0 1 ${1222 - overtimeOffset} 477.5537)`}>
										<tspan x="0" y="0"
											fill={RED}
											fontFamily="'myriad-pro'"
											fontWeight={(getFinalsMatchWinnerForDisplay(13)?.winner === "red") ? black : semibold}
											fontStyle={"normal"}
											fontSize="14px" textAnchor="middle">{getFinalsMatchScoreForDisplay(13, "red")}</tspan>
										<tspan x="0" y="14" fill={BLUE}
											fontFamily="'myriad-pro'"
											fontWeight={(getFinalsMatchWinnerForDisplay(13)?.winner === "blue") ? black : semibold}
											fontStyle={"normal"}
											fontSize="14px" textAnchor="middle">{getFinalsMatchScoreForDisplay(13, "blue")}</tspan>
									</text>
								</>
							)}
							...
							{shouldDisplayFinalsMatch(14) && (
								<>
									<circle id="winnerMatch5Dot" fill={(getFinalsMatchWinnerForDisplay(14)?.winner === "red") ? RED : (getFinalsMatchWinnerForDisplay(14)?.winner === "blue") ? BLUE : (getFinalsMatchWinnerForDisplay(14)?.winner === "tie") ? GREEN : "none"} cx={`${1252 - overtimeOffset}`} cy="451" r="8" />
							...
							{shouldDisplayFinalsMatch(15) && (
								<>
									<circle id="winnerMatch6Dot" fill={(getFinalsMatchWinnerForDisplay(15)?.winner === "red") ? RED : (getFinalsMatchWinnerForDisplay(15)?.winner === "blue") ? BLUE : (getFinalsMatchWinnerForDisplay(15)?.winner === "tie") ? GREEN : "none"} cx={`${1282 - overtimeOffset}`} cy="451" r="8" />
									<text id="finalsM5Scores"
						...
						<g id="match9" onClick={() => { setMatchWinner(9) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 906.5 519.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(9, "blue") ? getAllianceNameForDisplay(9, "blue") : "Winner of M8"}</tspan>
								...
								<circle id="match9RedDot" fill={(getMatchWinnerForDisplay(9)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(9)?.winner === "tie") ? GREEN : "none")} cx="993" cy="483" r="8" />
								<circle id="match9BlueDot" fill={(getMatchWinnerForDisplay(9)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(9)?.winner === "tie") ? GREEN : "none")} cx="993" cy="520" r="8" />

								<text id="M9BlueScore" transform="matrix(1 0 0 1 972 525.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(9, "blue")}</text>

								<text id="M9RedScore" transform="matrix(1 0 0 1 972 489.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(9, "red")}</text>
							</g>
						</g>
						<g id="match8" onClick={() => { setMatchWinner(8) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 725 589.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(8, "blue") ? getAllianceNameForDisplay(8, "blue") : "Winner of M5"}</tspan>
								...
								<circle id="match8RedDot" fill={(getMatchWinnerForDisplay(8)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(8)?.winner === "tie") ? GREEN : "none")} cx="814" cy="556" r="8" />
								<circle id="match8BlueDot" fill={(getMatchWinnerForDisplay(8)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(8)?.winner === "tie") ? GREEN : "none")} cx="814" cy="593" r="8" />

								<text id="M8BlueScore" transform="matrix(1 0 0 1 792 595.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(8, "blue")}</text>

								<text id="M8RedScore" transform="matrix(1 0 0 1 792 559.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(8, "red")}</text>
							</g>
						</g>
						<g id="match7" onClick={() => { setMatchWinner(7) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 725 269.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(7, "blue") ? getAllianceNameForDisplay(7, "blue") : "Winner of M4"}</tspan>
								...
								<circle id="match7RedDot" fill={(getMatchWinnerForDisplay(7)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(7)?.winner === "tie") ? GREEN : "none")} cx="814" cy="236" r="8" />
								<circle id="match7BlueDot" fill={(getMatchWinnerForDisplay(7)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(7)?.winner === "tie") ? GREEN : "none")} cx="814" cy="273" r="8" />

								<text id="M7BlueScore" transform="matrix(1 0 0 1 792 277.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(7, "blue")}</text>

								<text id="M7RedScore" transform="matrix(1 0 0 1 792 241.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(7, "red")}</text>
							</g>
						</g>
						<g id="match6" onClick={() => { setMatchWinner(6) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 533 523.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(6, "blue") ? getAllianceNameForDisplay(6, "blue") : "Losing Alliance of M1"}</tspan>
								...
								<circle id="match6RedDot" fill={(getMatchWinnerForDisplay(6)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(6)?.winner === "tie") ? GREEN : "none")} cx="623" cy="490" r="8" />
								<circle id="match6BlueDot" fill={(getMatchWinnerForDisplay(6)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(6)?.winner === "tie") ? GREEN : "none")} cx="623" cy="527" r="8" />

								<text id="M6BlueScore" transform="matrix(1 0 0 1 599 532.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(6, "blue")}</text>

								<text id="M6RedScore" transform="matrix(1 0 0 1 599 496.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(6, "red")}</text>
							</g>
						</g>
						<g id="match5" onClick={() => { setMatchWinner(5) }}>
							<g>
								...
								<circle id="match5RedDot" fill={(getMatchWinnerForDisplay(5)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(5)?.winner === "tie") ? GREEN : "none")} cx="623" cy="629" r="8" />
								<circle id="match5BlueDot" fill={(getMatchWinnerForDisplay(5)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(5)?.winner === "tie") ? GREEN : "none")} cx="623" cy="666" r="8" />

								<text id="M5BlueScore" transform="matrix(1 0 0 1 599 669.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(5, "blue")}</text>

								<text id="M5RedScore" transform="matrix(1 0 0 1 599 633.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(5, "red")}</text>
							</g>
						</g>
						<g id="match4" onClick={() => { setMatchWinner(4) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 334.6 343.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(4, "blue") ? getAllianceNameForDisplay(4, "blue") : "Winner of M2"}</tspan>
								...
								<circle id="match4RedDot" fill={(getMatchWinnerForDisplay(4)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(4)?.winner === "tie") ? GREEN : "none")} cx="426" cy="309" r="8" />
								<circle id="match4BlueDot" fill={(getMatchWinnerForDisplay(4)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(4)?.winner === "tie") ? GREEN : "none")} cx="426" cy="346" r="8" />

								<text id="M4BlueScore" transform="matrix(1 0 0 1 403 352.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(4, "blue")}</text>

								<text id="M4RedScore" transform="matrix(1 0 0 1 403 316.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(4, "red")}</text>
							</g>
						</g>
						<g id="match3" onClick={() => { setMatchWinner(3) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 334.6 189.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(3, "blue") ? getAllianceNameForDisplay(3, "blue") : "Winner of M1"}</tspan>
								...
								<circle id="match3RedDot" fill={(getMatchWinnerForDisplay(3)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(3)?.winner === "tie") ? GREEN : "none")} cx="426" cy="156" r="8" />
								<circle id="match3BlueDot" fill={(getMatchWinnerForDisplay(3)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(3)?.winner === "tie") ? GREEN : "none")} cx="426" cy="193" r="8" />

								<text id="M3BlueScore" transform="matrix(1 0 0 1 403 196.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(3, "blue")}</text>

								<text id="M3RedScore" transform="matrix(1 0 0 1 403 160.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(3, "red")}</text>
							</g>
						</g>
						<g id="match2" onClick={() => { setMatchWinner(2) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 145.6 382.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(2, "blue") ? getAllianceNameForDisplay(2, "blue") : "Alliance 6"}</tspan>
									<tspan x="0" y="14.58" fill="#FFFFFF" fontFamily={getAllianceNumbersForDisplay(2, "blue").length > 20 ? "'myriad-pro-condensed'" : "'myriad-pro'"} fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNumbersForDisplay(2, "blue")}</tspan></text>
								<circle id="match2RedDot" fill={(getMatchWinnerForDisplay(2)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(2)?.winner === "tie") ? GREEN : "none")} cx="237" cy="350" r="8" />
								<circle id="match2BlueDot" fill={(getMatchWinnerForDisplay(2)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(2)?.winner === "tie") ? GREEN : "none")} cx="237" cy="387" r="8" />

								<text id="M2BlueScore" transform="matrix(1 0 0 1 214 391.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(2, "blue")}</text>

								<text id="M2RedScore" transform="matrix(1 0 0 1 214 355.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(2, "red")}</text>
							</g>
						</g>
						<g id="match1" onClick={() => { setMatchWinner(1) }}>
							<g>
								...
								<text transform="matrix(0.9941 0 0 1 145.6 228.6221)" textAnchor="middle">
									<tspan x="0" y="0" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNameForDisplay(1, "blue") ? getAllianceNameForDisplay(1, "blue") : "Alliance 5"}</tspan><tspan x="0" y="14.58" fill="#FFFFFF" fontFamily={getAllianceNumbersForDisplay(1, "blue").length > 20 ? "'myriad-pro-condensed'" : "'myriad-pro'"} fontWeight={bold} fontStyle={"normal"} fontSize="12.1471px">{getAllianceNumbersForDisplay(1, "blue")}</tspan></text>
								<circle id="match1RedDot" fill={(getMatchWinnerForDisplay(1)?.winner === "red") ? GOLD : ((getMatchWinnerForDisplay(1)?.winner === "tie") ? GREEN : "none")} cx="237" cy="195" r="8" />
								<circle id="match1BlueDot" fill={(getMatchWinnerForDisplay(1)?.winner === "blue") ? GOLD : ((getMatchWinnerForDisplay(1)?.winner === "tie") ? GREEN : "none")} cx="237" cy="232" r="8" />

								<text id="M1BlueScore" transform="matrix(1 0 0 1 214 236.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(1, "blue")}</text>

								<text id="M1RedScore" transform="matrix(1 0 0 1 214 200.6279)" fill="#FFFFFF" fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="15px" textAnchor="middle">{getMatchScoreForDisplay(1, "red")}</text>
							</g>
						</g>
					</svg>
				</>}
