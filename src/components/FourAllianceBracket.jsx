...
function FourAllianceBracket({ selectedEvent, playoffSchedule, alliances, currentMatch, qualsLength, nextMatch, previousMatch, getSchedule, useSwipe, usePullDownToUpdate, offlinePlayoffSchedule, setOfflinePlayoffSchedule,eventLabel }) {
	...
	const matchClasses = [
		{ "matchNumber": 1, "description": "Match 1 (R1) (#1)", "winnerTo": { "matchNumber": 3, "station": "red" }, "loserTo": { "matchNumber": 4, "station": "red" }, },
		{ "matchNumber": 2, "description": "Match 2 (R1) (#2)", "winnerTo": { "matchNumber": 3, "station": "blue" }, "loserTo": { "matchNumber": 4, "station": "blue" }, },
		{ "matchNumber": 3, "description": "Match 3 (R2) (#3)", "winnerTo": { "matchNumber": 6, "station": "red" }, "loserTo": { "matchNumber": 5, "station": "red" }, },
		{ "matchNumber": 4, "description": "Match 4 (R2) (#4)", "winnerTo": { "matchNumber": 5, "station": "blue" }, "loserTo": null, },
		{ "matchNumber": 5, "description": "Match 5 (R3) (#5)", "winnerTo": { "matchNumber": 6, "station": "blue" }, "loserTo": null },
		{ "matchNumber": 6, "description": "Final 1 (#6)", "winnerTo": { "matchNumber": 7, "station": "blue" }, "loserTo": { "matchNumber": 7, "station": "red" }, },
		{ "matchNumber": 7, "description": "Final 2 (#7)", "winnerTo": { "matchNumber": 8, "station": "blue" }, "loserTo": { "matchNumber": 8, "station": "red" }, },
		{ "matchNumber": 8, "description": "Final 3 (#8)", "winnerTo": { "matchNumber": 9, "station": "blue" }, "loserTo": { "matchNumber": 9, "station": "red" }, },
		{ "matchNumber": 9, "description": "Overtime 1 (#9)", "winnerTo": { "matchNumber": 10, "station": "blue" }, "loserTo": { "matchNumber": 10, "station": "red" }, },
		{ "matchNumber": 10, "description": "Overtime 2 (#10)", "winnerTo": { "matchNumber": 11, "station": "red" }, "loserTo": { "matchNumber": 11, "station": "blue" }, },
		{ "matchNumber": 12, "description": "Overtime 3 (#11)", "winnerTo": null, "loserTo": null, },
	]
					...
					<svg id="FourAllianceBracket" data-name="FourAllianceBracket" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1076 686">
						...
						<g id="finals" onClick={() => { setMatchWinner(6) }}>
							...
							<g id="finalsContainer">
								...
								<text transform="translate(811.78 357.63) rotate(-90)" fill={currentPlayoffMatch >= 6 ? BLACK : WHITE} fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.076px">BEST 2 of 3</text>
						...
						<g id="match4" onClick={() => { setMatchWinner(4) }}>
							<g>
								...
								<rect x="291" y="538.54" width="22.43" height="72.46" fill={currentPlayoffMatch === 4 ? GOLD : BLACK} />
								<text transform="matrix(0 -1.0059 1 0 306.78 598.26)" fill={currentPlayoffMatch === 4 ? BLACK : WHITE} fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.076px">MATCH 4</text>
						...
						<g id="match3" onClick={() => { setMatchWinner(3) }}>
							<g>
								...
								<rect x="289" y="138.54" width="22.43" height="72.46" fill={currentPlayoffMatch === 3 ? GOLD : BLACK} />
								<text transform="matrix(0 -1.0059 1 0 304.78 198.26)" fill={currentPlayoffMatch === 3 ? BLACK : WHITE} fontFamily="'myriad-pro'" fontWeight={bold} fontStyle={"normal"} fontSize="12.076px">MATCH 3</text>
