            ...
            {selectedEvent && <div>
                ...
                <Row className="leftTable">
                    <Col sm={4}>
                        ...
                        <img style={{ width: "300px" }} src="/images/crescendo.gif" alt="FIRST In Show CRESCENDO Logo" />
                    </Col>
                    <Col sm={4}>
                    ...
                    <Col sm={4}>
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <Switch checked={hidePracticeSchedule === null ? false : hidePracticeSchedule} onChange={setHidePracticeSchedule} />
                                    </td>
                                    <td>
