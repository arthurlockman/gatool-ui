            ...
            {selectedEvent && <div>
                ...
                <Row className="leftTable">
                    <Col sm={4}>
                        ...
                        {(selectedEvent?.value.type === "OffSeason") && selectedEvent?.value?.tbaEventKey && <p>Using TBA event key <b>{selectedEvent?.value?.tbaEventKey}</b> for data</p>}
                        ...
                        <table>
                            <tbody>
                                ...
                                {showUISettings && <><tr className={"UISettings"}>
                                    ...
                                    <tr className={"UISettings"}>
                                        <td>
                                            <Switch checked={(_.isNull(useScrollMemory) || _.isUndefined(useScrollMemory)) ? true : useScrollMemory} onChange={setUseScrollMemory} />
                                        </td>
                                        <td>
                                            <b>Enable screen scroll memory</b>
                                        </td>
                                    </tr>
                                    <tr className={"UISettings"}>
                                        <td colSpan={2}>
