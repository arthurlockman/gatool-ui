            ...
            {selectedEvent && <div>
                ...
                <Row className="leftTable">
                    <Col sm={4}>
                        ...
                        {(selectedEvent?.value.type === "OffSeason") && tbaEventKey && <p>Using TBA event key <b>{tbaEventKey}</b> for data</p>}
