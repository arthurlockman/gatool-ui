        ...
        <Container fluid>
            <Container fluid>{!selectedEvent && <div>
                ...
                {selectedEvent && qualSchedule?.schedule?.length > 0 && !playoffs && <div>
                    ...
                    {!allianceSelection && <Alert variant="danger" ><div onClick={getRanks}><b>Do not proceed with Alliance Selection until you confirm that the rank order below agrees with the rank order in FMS. Tap this alert to see if we can get a more current schedule and rankings.</b></div>
